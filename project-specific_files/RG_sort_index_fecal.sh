...
ls *.bam | parallel --env THREADS_PER_JOB,OUTDIR -j "$JOBS" "
    ...
    case \$field_count in
        ...
        *)
            ...
            #i032_C05_IDGW_S7_HIGH_UI0435_111FR.bam
            #i036_A06_IDGW_S16_MID1_MID2_1112EQ.bam
            #i036_A06_IDGW_S16_MID1_MID2_UI0000_99999.bam
            index=\$(echo \$SAMPLE | cut -d'_' -f1)
            well=\$(echo \$SAMPLE | cut -d'_' -f2)
            lib=\$(echo \$SAMPLE | cut -d'_' -f4)
